...
├── model/       # Clases de dominio (Persona, Cliente, Colaboradores, GuiaTuristico, etc.)
...
```bash
git clone https://github.com/Bustos-git/LlanquihueTourFinal
```
...
**Repositorio GitHub:** https://github.com/Bustos-git/LlanquihueTourFinal
